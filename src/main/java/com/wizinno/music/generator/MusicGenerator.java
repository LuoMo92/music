package com.wizinno.music.generator;


import cn.hutool.core.util.StrUtil;
import com.wizinno.music.generator.bean.EntityOfEntity;
...
public class MusicGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "Liumei";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "com.wizinno.music.domain";

    /**
     * dao对应包
     */
    private static final String daoPackage = "com.wizinno.music.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.wizinno.music.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.wizinno.music.service.impl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.wizinno.music.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/generator/template";
...
//        deleteCode(className);
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/domain/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/service/impl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/com/wizinno/music/controller/"+className+"Controller.java";
