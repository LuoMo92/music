package com.wizinno.music.common.aop;

import cn.hutool.core.util.StrUtil;
import com.wizinno.music.common.annotation.SystemLog;
import com.wizinno.music.common.utils.IpInfoUtil;
import com.wizinno.music.common.utils.ThreadPoolUtil;
import com.wizinno.music.domain.Log;
import com.wizinno.music.domain.elasticsearch.EsLog;
import com.wizinno.music.service.LogService;
import com.wizinno.music.service.elasticsearch.EsLogService;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.wizinno.music.common.annotation.SystemLog)")
    public void controllerAspect() {
    }

    /**
     * 前置通知 (在方法执行之前返回)用于记录用户的操作的开始时间
     *
     * @param joinPoint 切点
